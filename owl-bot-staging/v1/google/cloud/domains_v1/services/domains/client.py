...
class DomainsClient(metaclass=DomainsClientMeta):
    ...
    def retrieve_register_parameters(self,
            request: Optional[Union[domains.RetrieveRegisterParametersRequest, dict]] = None,
            *,
            location: Optional[str] = None,
    ...
    def retrieve_transfer_parameters(self,
            request: Optional[Union[domains.RetrieveTransferParametersRequest, dict]] = None,
            *,
            location: Optional[str] = None,
            domain_name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def configure_management_settings(self,
            request: Optional[Union[domains.ConfigureManagementSettingsRequest, dict]] = None,
            *,
