...
def test_domains_client_client_options_from_dict():
    with mock.patch('google.cloud.domains_v1.services.domains.transports.DomainsGrpcTransport.__init__') as grpc_transport:
...
def test_search_domains_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{location=projects/*/locations/*}/registrations:searchDomains" % client.transport._host, args[1])
...
def test_retrieve_register_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{location=projects/*/locations/*}/registrations:retrieveRegisterParameters" % client.transport._host, args[1])
...
def test_register_domain_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/registrations:register" % client.transport._host, args[1])
...
def test_retrieve_transfer_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{location=projects/*/locations/*}/registrations:retrieveTransferParameters" % client.transport._host, args[1])
...
def test_transfer_domain_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/registrations:transfer" % client.transport._host, args[1])
...
def test_list_registrations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/registrations" % client.transport._host, args[1])
...
def test_get_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registrations/*}" % client.transport._host, args[1])
...
def test_update_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{registration.name=projects/*/locations/*/registrations/*}" % client.transport._host, args[1])
...
def test_configure_management_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{registration=projects/*/locations/*/registrations/*}:configureManagementSettings" % client.transport._host, args[1])
...
def test_configure_dns_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{registration=projects/*/locations/*/registrations/*}:configureDnsSettings" % client.transport._host, args[1])
...
def test_configure_contact_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{registration=projects/*/locations/*/registrations/*}:configureContactSettings" % client.transport._host, args[1])
...
def test_export_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registrations/*}:export" % client.transport._host, args[1])
...
def test_retrieve_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{registration=projects/*/locations/*/registrations/*}:retrieveAuthorizationCode" % client.transport._host, args[1])
...
def test_reset_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{registration=projects/*/locations/*/registrations/*}:resetAuthorizationCode" % client.transport._host, args[1])
...
def test_domains_base_transport():
    ...
    with mock.patch('google.cloud.domains_v1.services.domains.transports.DomainsTransport.__init__') as Transport:
...
def test_domains_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.domains_v1.services.domains.transports.DomainsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_domains_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.domains_v1.services.domains.transports.DomainsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DomainsTransport()
        adc.assert_called_once()
