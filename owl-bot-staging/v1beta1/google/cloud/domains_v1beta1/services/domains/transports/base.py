...
class DomainsTransport(abc.ABC):
    ...
    @property
    def search_domains(self) -> typing.Callable[
    ...
    @property
    def retrieve_register_parameters(self) -> typing.Callable[
            [domains.RetrieveRegisterParametersRequest],
            typing.Union[
                domains.RetrieveRegisterParametersResponse,
                typing.Awaitable[domains.RetrieveRegisterParametersResponse]
            ]]:
        raise NotImplementedError()

    @property
    def register_domain(self) -> typing.Callable[
    ...
    @property
    def list_registrations(self) -> typing.Callable[
            [domains.ListRegistrationsRequest],
            typing.Union[
                domains.ListRegistrationsResponse,
                typing.Awaitable[domains.ListRegistrationsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_registration(self) -> typing.Callable[
            [domains.GetRegistrationRequest],
            typing.Union[
                domains.Registration,
                typing.Awaitable[domains.Registration]
            ]]:
        raise NotImplementedError()

    @property
    def update_registration(self) -> typing.Callable[
    ...
    @property
    def configure_management_settings(self) -> typing.Callable[
    ...
    @property
    def configure_dns_settings(self) -> typing.Callable[
    ...
    @property
    def configure_contact_settings(self) -> typing.Callable[
    ...
    @property
    def export_registration(self) -> typing.Callable[
    ...
    @property
    def delete_registration(self) -> typing.Callable[
    ...
    @property
    def retrieve_authorization_code(self) -> typing.Callable[
            [domains.RetrieveAuthorizationCodeRequest],
            typing.Union[
                domains.AuthorizationCode,
                typing.Awaitable[domains.AuthorizationCode]
            ]]:
        raise NotImplementedError()

    @property
    def reset_authorization_code(self) -> typing.Callable[
