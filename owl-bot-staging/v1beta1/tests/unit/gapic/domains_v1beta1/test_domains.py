...
@pytest.mark.parametrize("client_class", [
    DomainsClient, DomainsAsyncClient
])
@mock.patch.object(DomainsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DomainsClient))
@mock.patch.object(DomainsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DomainsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (DomainsAsyncClient, transports.DomainsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DomainsClient, transports.DomainsRestTransport, "rest", None),
])
def test_domains_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_domains_client_client_options_from_dict():
    with mock.patch('google.cloud.domains_v1beta1.services.domains.transports.DomainsGrpcTransport.__init__') as grpc_transport:
...
def test_domains_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_list_registrations_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_registrations(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_search_domains_rest_required_fields(request_type=domains.SearchDomainsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_domains._get_unset_required_fields(jsonified_request)
...
def test_search_domains_rest_unset_required_fields():
    transport = transports.DomainsRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.search_domains._get_unset_required_fields({})
    assert set(unset_fields) == (set(("query", )) & set(("query", "location", )))
...
def test_search_domains_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DomainsRestInterceptor, "post_search_domains") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_search_domains") as pre:
        ...
        req.return_value._content = domains.SearchDomainsResponse.to_json(domains.SearchDomainsResponse())
        ...
        client.search_domains(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_domains_rest_bad_request(transport: str = 'rest', request_type=domains.SearchDomainsRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_domains_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{location=projects/*/locations/*}/registrations:searchDomains" % client.transport._host, args[1])
...
def test_retrieve_register_parameters_rest_required_fields(request_type=domains.RetrieveRegisterParametersRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_register_parameters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_retrieve_register_parameters_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("domainName", )) & set(("domainName", "location", )))
...
def test_retrieve_register_parameters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainsRestInterceptor, "post_retrieve_register_parameters") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_retrieve_register_parameters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.RetrieveRegisterParametersRequest.pb(domains.RetrieveRegisterParametersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = domains.RetrieveRegisterParametersResponse.to_json(domains.RetrieveRegisterParametersResponse())
        ...
        client.retrieve_register_parameters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_retrieve_register_parameters_rest_bad_request(transport: str = 'rest', request_type=domains.RetrieveRegisterParametersRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_retrieve_register_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{location=projects/*/locations/*}/registrations:retrieveRegisterParameters" % client.transport._host, args[1])
...
def test_register_domain_rest_required_fields(request_type=domains.RegisterDomainRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).register_domain._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_register_domain_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "registration", "yearlyPrice", )))
...
def test_register_domain_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DomainsRestInterceptor, "post_register_domain") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_register_domain") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.register_domain(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_register_domain_rest_bad_request(transport: str = 'rest', request_type=domains.RegisterDomainRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_register_domain_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/registrations:register" % client.transport._host, args[1])
...
def test_retrieve_transfer_parameters_rest_required_fields(request_type=domains.RetrieveTransferParametersRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_transfer_parameters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_retrieve_transfer_parameters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainsRestInterceptor, "post_retrieve_transfer_parameters") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_retrieve_transfer_parameters") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.RetrieveTransferParametersRequest.pb(domains.RetrieveTransferParametersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = domains.RetrieveTransferParametersResponse.to_json(domains.RetrieveTransferParametersResponse())
        ...
        client.retrieve_transfer_parameters(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_retrieve_transfer_parameters_rest_bad_request(transport: str = 'rest', request_type=domains.RetrieveTransferParametersRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_retrieve_transfer_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{location=projects/*/locations/*}/registrations:retrieveTransferParameters" % client.transport._host, args[1])
...
def test_transfer_domain_rest_required_fields(request_type=domains.TransferDomainRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).transfer_domain._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transfer_domain_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_transfer_domain") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_transfer_domain") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.transfer_domain(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_transfer_domain_rest_bad_request(transport: str = 'rest', request_type=domains.TransferDomainRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transfer_domain_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/registrations:transfer" % client.transport._host, args[1])
...
def test_list_registrations_rest_required_fields(request_type=domains.ListRegistrationsRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_registrations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_registrations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainsRestInterceptor, "post_list_registrations") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_list_registrations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.ListRegistrationsRequest.pb(domains.ListRegistrationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = domains.ListRegistrationsResponse.to_json(domains.ListRegistrationsResponse())
        ...
        client.list_registrations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_registrations_rest_bad_request(transport: str = 'rest', request_type=domains.ListRegistrationsRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_registrations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/registrations" % client.transport._host, args[1])
...
def test_get_registration_rest_required_fields(request_type=domains.GetRegistrationRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainsRestInterceptor, "post_get_registration") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_get_registration") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_registration(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_registration_rest_bad_request(transport: str = 'rest', request_type=domains.GetRegistrationRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/registrations/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/registrations/*}" % client.transport._host, args[1])
...
def test_update_registration_rest_required_fields(request_type=domains.UpdateRegistrationRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_update_registration") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_update_registration") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.UpdateRegistrationRequest.pb(domains.UpdateRegistrationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_registration(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_registration_rest_bad_request(transport: str = 'rest', request_type=domains.UpdateRegistrationRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'registration': {'name': 'projects/sample1/locations/sample2/registrations/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{registration.name=projects/*/locations/*/registrations/*}" % client.transport._host, args[1])
...
def test_configure_management_settings_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'registration': 'projects/sample1/locations/sample2/registrations/sample3'}
    request = request_type(**request_init)
...
def test_configure_management_settings_rest_required_fields(request_type=domains.ConfigureManagementSettingsRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).configure_management_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_configure_management_settings_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("registration", "updateMask", )))
...
def test_configure_management_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_configure_management_settings") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_configure_management_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.ConfigureManagementSettingsRequest.pb(domains.ConfigureManagementSettingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.configure_management_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_configure_management_settings_rest_bad_request(transport: str = 'rest', request_type=domains.ConfigureManagementSettingsRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_configure_management_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'registration': 'projects/sample1/locations/sample2/registrations/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:configureManagementSettings" % client.transport._host, args[1])
...
def test_configure_dns_settings_rest_required_fields(request_type=domains.ConfigureDnsSettingsRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).configure_dns_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_configure_dns_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_configure_dns_settings") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_configure_dns_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.ConfigureDnsSettingsRequest.pb(domains.ConfigureDnsSettingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.configure_dns_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_configure_dns_settings_rest_bad_request(transport: str = 'rest', request_type=domains.ConfigureDnsSettingsRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_configure_dns_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:configureDnsSettings" % client.transport._host, args[1])
...
def test_configure_contact_settings_rest_required_fields(request_type=domains.ConfigureContactSettingsRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).configure_contact_settings._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_configure_contact_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_configure_contact_settings") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_configure_contact_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.ConfigureContactSettingsRequest.pb(domains.ConfigureContactSettingsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.configure_contact_settings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_configure_contact_settings_rest_bad_request(transport: str = 'rest', request_type=domains.ConfigureContactSettingsRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_configure_contact_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:configureContactSettings" % client.transport._host, args[1])
...
def test_export_registration_rest_required_fields(request_type=domains.ExportRegistrationRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_export_registration") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_export_registration") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.ExportRegistrationRequest.pb(domains.ExportRegistrationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_registration(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_export_registration_rest_bad_request(transport: str = 'rest', request_type=domains.ExportRegistrationRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/registrations/*}:export" % client.transport._host, args[1])
...
def test_delete_registration_rest_required_fields(request_type=domains.DeleteRegistrationRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.DomainsRestInterceptor, "post_delete_registration") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_delete_registration") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.DeleteRegistrationRequest.pb(domains.DeleteRegistrationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_registration(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_registration_rest_bad_request(transport: str = 'rest', request_type=domains.DeleteRegistrationRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_retrieve_authorization_code_rest_required_fields(request_type=domains.RetrieveAuthorizationCodeRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_authorization_code._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_retrieve_authorization_code_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainsRestInterceptor, "post_retrieve_authorization_code") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_retrieve_authorization_code") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.RetrieveAuthorizationCodeRequest.pb(domains.RetrieveAuthorizationCodeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = domains.AuthorizationCode.to_json(domains.AuthorizationCode())
        ...
        client.retrieve_authorization_code(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_retrieve_authorization_code_rest_bad_request(transport: str = 'rest', request_type=domains.RetrieveAuthorizationCodeRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_retrieve_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:retrieveAuthorizationCode" % client.transport._host, args[1])
...
def test_reset_authorization_code_rest_required_fields(request_type=domains.ResetAuthorizationCodeRequest):
    transport_class = transports.DomainsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_authorization_code._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_authorization_code_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DomainsRestInterceptor, "post_reset_authorization_code") as post, \
         mock.patch.object(transports.DomainsRestInterceptor, "pre_reset_authorization_code") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = domains.ResetAuthorizationCodeRequest.pb(domains.ResetAuthorizationCodeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.reset_authorization_code(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_reset_authorization_code_rest_bad_request(transport: str = 'rest', request_type=domains.ResetAuthorizationCodeRequest):
    client = DomainsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_reset_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:resetAuthorizationCode" % client.transport._host, args[1])
...
def test_domains_base_transport():
    ...
    with mock.patch('google.cloud.domains_v1beta1.services.domains.transports.DomainsTransport.__init__') as Transport:
...
def test_domains_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.domains_v1beta1.services.domains.transports.DomainsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_domains_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.domains_v1beta1.services.domains.transports.DomainsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DomainsTransport()
        adc.assert_called_once()
